...
$remotePath = "/var/www/html/istaqim"
$tarName = "istaqim_deploy.tar"
...
tar --exclude='node_modules' --exclude='.git' --exclude='*.tar' --exclude='scripts' --exclude='build' --exclude='deploy-to-server.ps1' -cf $tarName .
